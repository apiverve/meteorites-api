...
namespace APIVerve.API.MeteoriteLandings
{
    ...
    /// <summary>
    /// Client for the MeteoriteLandings API
    /// </summary>
    public class MeteoriteLandingsAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/meteorites";
        ...
        {
            { "name", new ValidationRule { Type = "string", Required = false } },
            { "mass", new ValidationRule { Type = "number", Required = false } },
            { "year", new ValidationRule { Type = "number", Required = false } }
        };
        ...
        public MeteoriteLandingsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MeteoriteLandingsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MeteoriteLandingsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MeteoriteLandingsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MeteoriteLandingsQueryOptions options)
        {
        ...
        public ResponseObj Execute(MeteoriteLandingsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MeteoriteLandingsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MeteoriteLandingsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MeteoriteLandingsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MeteoriteLandingsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MeteoriteLandingsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MeteoriteLandingsQueryOptions options)
        {
