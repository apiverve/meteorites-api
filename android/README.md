# Meteorite Landings Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:meteorites-api:1.1.13'
}
```
...
```java
import com.apiverve.meteorites.MeteoriteLandingsAPIClient;
import com.apiverve.meteorites.APIResponse;
import com.apiverve.meteorites.APIException;

// Initialize the client
MeteoriteLandingsAPIClient client = new MeteoriteLandingsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name", "Allende");
    parameters.put("mass", 0);
    parameters.put("year", 0);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/meteorites](https://docs.apiverve.com/ref/meteorites)
...
- **Documentation:** [https://docs.apiverve.com/ref/meteorites](https://docs.apiverve.com/ref/meteorites)
- **Issues:** [GitHub Issues](https://github.com/apiverve/meteorites-api/issues)
