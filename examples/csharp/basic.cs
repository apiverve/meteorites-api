...
{
    class MeteoriteLandingsExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/meteorites";

        /// <summary>
        /// Make a GET request to the Meteorite Landings API
        /// </summary>
        static async Task<JsonDocument> CallMeteoriteLandingsAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;name&quot;] &#x3D; &quot;Allende&quot;, [&quot;mass&quot;] &#x3D; , [&quot;year&quot;] &#x3D;  };
        ...
        {
            Console.WriteLine("📤 Calling Meteorite Landings API...\n");

            var result = await CallMeteoriteLandingsAPI();
