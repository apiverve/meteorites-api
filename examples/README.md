# Meteorite Landings API - Examples

This folder contains example code for using the Meteorite Landings API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/meteorites',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/meteorites");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/meteorites](https://docs.apiverve.com/ref/meteorites)
