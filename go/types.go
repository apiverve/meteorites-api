// Package meteorites provides a Go client for the Meteorite Landings API.
//
// For more information, visit: https://apiverve.com/marketplace/meteorites?utm_source=go&utm_medium=readme
package meteorites
...
// Request contains the parameters for the Meteorite Landings API.
//
// Parameters:
//   - name: string - The name of the meteorite you want to search for
//   - mass: number - The mass of the meteorite in grams
//   - year: number - The year the meteorite fell to Earth
type Request struct {
	Name string `json:"name,omitempty"` // Optional
	Mass float64 `json:"mass,omitempty"` // Optional
	Year float64 `json:"year,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Meteorite Landings API.
type ResponseData struct {
	Count int `json:"count"`
	FilteredOn []string `json:"filteredOn"`
	Meteors []MeteorsItem `json:"meteors"`
}

// MeteorsItem represents an item in the Meteors array.
type MeteorsItem struct {
	Name string `json:"name"`
	Recclass string `json:"recclass"`
	Mass string `json:"mass"`
	Year string `json:"year"`
	Geolocation GeolocationData `json:"geolocation"`
}

// GeolocationData represents the geolocation object.
